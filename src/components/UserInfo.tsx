        ...
        <div className="p-4 border-t border-gray-200 mt-4">
            ...
            >
                ...
                <div>
                    ...
                    <p className="text-sm text-dark-text whitespace-nowrap">
                        Gói: {currentUser?.subscription?.package_name || 'Chưa kích hoạt'}
                    </p>
                    {currentUser?.subscription && (
                        <p className="text-xs text-dark-text whitespace-nowrap">
                            Hết hạn: {formatDate(currentUser.subscription.end_date)}
                        </p>
                    )}
                </div>
            </div>
